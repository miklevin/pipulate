...
class PipeFlow:
    APP_NAME = "pipeflow" 
    DISPLAY_NAME = "Mad Libs"
    ENDPOINT_MESSAGE = "This workflow guides you through a step-by-step process to build a sentence. Enter an ID, which will let you pull up this workflow again. Then complete each field and finalize when done."
    TRAINING_PROMPT = "pipe_flow.md"
    ...
    def __init__(self, app, pipulate, pipeline, db, app_name=APP_NAME):
        ...
        steps = [
            Step(id='step_01', done='data', show='Animal Name', refill=False, transform=None),
