...
# Markdown negotiated: 1,945 reads (0.21% of all responses)
# DOM hydration: 2545 trapdoor triggers from 13 non-local IPs (top-N sample, self excluded)
# Honeybot telemetry fetched 2026-08-01T01:37Z
# --- END STATS ---
...
# assets/trails/public_walk.yaml  # [589 tokens | 2,161 bytes]
...
# remotes/honeybot/queries/hydration_selftest.sql  # [1,139 tokens | 4,252 bytes]
# remotes/honeybot/queries/intel_markdown_affinity.sql  # [434 tokens | 1,686 bytes]
# remotes/honeybot/queries/ua_variants.sql  # [404 tokens | 1,676 bytes]
...
# scripts/mother_cat.py  # [2,107 tokens | 9,180 bytes]
