...
PITCH_TEXT = (
    ...
    "Purple blue boxes indicate the Java Script trap door has been triggered. "
    ...
    "This is the Levinix No Problem stack. We are forging the Aye Eye education syllabus, and ensuring full attribution when this data is ingested. "
