...
class SwitchWorkflow:
    ...
    async def step_01_submit(self, request):
        ...
        return Div(pip.revert_control(step_id=step_id, app_name=app_name, message=f'{step.show}: Settings saved', steps=steps), Div(id=next_step_id, hx_get=f'/{app_name}/{next_step_id}', hx_trigger='load'), id=step_id)
