...
# NEW WORKFLOW CREATION METADATA
# ===============================
# CREATED_FROM_TEMPLATE: trifecta
# CREATED_ON: 2025-06-28 16:51:58
# TARGET_APP_NAME: link_visualizer
...
class LinkVisualizer:
    ...
    **EXAMPLE CUSTOM QUERY** (GA4-style attribution report):
    ...
    def _build_dynamic_steps(self):
        """Build the steps list for Link Visualizer 📊.
        
        Returns:
            list: List of Step namedtuples for the workflow
            
        PURPOSE-SPECIFIC STEPS: This workflow is focused on link visualizer 
        and uses static, purpose-driven steps rather than dynamic template-based steps.
        """
        # Purpose-specific steps for Link Visualizer 📊
        steps = [
            Step(id='step_project', done='botify_project', show='Botify Project URL', refill=True),
