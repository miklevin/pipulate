...
class RadioButtonWorkflow:
    ...
    APP_NAME = "radio_widget"        # Unique identifier for this workflow's routes and data
    DISPLAY_NAME = "Radio Button Widget" # User-friendly name shown in the UI
    ENDPOINT_MESSAGE = (             # Message shown on the workflow's landing page
        "Welcome to the Radio Button Widget! This is a focused environment for designing and testing "
        "radio button-based interactions in isolation. Use this space to prototype and refine your "
        "radio button designs without distractions."
    )
    TRAINING_PROMPT = (
        "This is a specialized workflow for designing and testing radio button interactions in isolation. "
        "It provides a clean environment to focus on radio button development without the complexity "
        "of a full workflow implementation."
    )
