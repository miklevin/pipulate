...
class BlankPlaceholder:
    ...
    A minimal template for creating new workflows with placeholder steps.
    """
    APP_NAME = 'placeholder'
    DISPLAY_NAME = 'Blank Placeholder'
    ENDPOINT_MESSAGE = 'Welcome to the Blank Placeholder.'
    TRAINING_PROMPT = 'This is a minimal template for creating new workflows with placeholder steps. It provides a clean starting point for workflow development.'
