...
<body>
    ...
    async def landing(self, render_items=None):
        ...
        return Div(
            ...
            Div(
                P(A(Span("📊", cls="emoji", style="visibility: hidden; margin-right: 0.25rem;"), f"{len(self.DOCS)} documents discovered", 
                    href="/docs", target="_blank",
                    style="color: var(--pico-primary); text-decoration: none;",
                    onmouseover="this.style.textDecoration='underline'; this.style.color='var(--pico-primary-hover)'; this.querySelector('.emoji').style.visibility='visible';",
                    onmouseout="this.style.textDecoration='none'; this.style.color='var(--pico-primary)'; this.querySelector('.emoji').style.visibility='hidden';"), 
                  style="margin: 0.25rem 0;"),
                P(A(Span("🌟", cls="emoji", style="visibility: hidden; margin-right: 0.25rem;"), f"{len(featured_docs)} featured guides", 
                    href="/docs?category=featured", target="_blank",
                    style="color: var(--pico-primary); text-decoration: none;",
                    onmouseover="this.style.textDecoration='underline'; this.style.color='var(--pico-primary-hover)'; this.querySelector('.emoji').style.visibility='visible';",
                    onmouseout="this.style.textDecoration='none'; this.style.color='var(--pico-primary)'; this.querySelector('.emoji').style.visibility='hidden';"), 
                  style="margin: 0.25rem 0;"),
                P(A(Span("📖", cls="emoji", style="visibility: hidden; margin-right: 0.25rem;"), f"{len(training_docs)} training files", 
                    href="/docs?category=training", target="_blank",
                    style="color: var(--pico-primary); text-decoration: none;",
                    onmouseover="this.style.textDecoration='underline'; this.style.color='var(--pico-primary-hover)'; this.querySelector('.emoji').style.visibility='visible';",
                    onmouseout="this.style.textDecoration='none'; this.style.color='var(--pico-primary)'; this.querySelector('.emoji').style.visibility='hidden';"), 
                  style="margin: 0.25rem 0;"),
                P(A(Span("⚙️", cls="emoji", style="visibility: hidden; margin-right: 0.25rem;"), f"{len(rules_docs)} framework rules", 
