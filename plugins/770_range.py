...
class RangeSelectorWorkflow:
    ...
    APP_NAME = "range_selector"      # Unique identifier for this workflow's routes and data
    DISPLAY_NAME = "Range Selector Widget" # User-friendly name shown in the UI
    ENDPOINT_MESSAGE = (             # Message shown on the workflow's landing page
        "Welcome to the Range Selector Widget! This is a focused environment for designing and testing "
        "range input-based interactions in isolation. Use this space to prototype and refine your "
        "range selector designs without distractions."
    )
    TRAINING_PROMPT = (
        "This is a specialized workflow for designing and testing range selector interactions in isolation. "
        "It provides a clean environment to focus on range selector development without the complexity "
        "of a full workflow implementation."
    )
